...
class MistralWeightMapper(HfWeightMapper):
    def __init__(self):
        ...
        # TODO okozlova: deprecate this via model implementation
        self.mm_module_mapping = {
            ...
            "patch_merger": "vision_language_adapter.patch_merger",
            }
        ...
        for key in list(weights.keys()):
            ...
            for i in range(num_modules):
                ...
                if combined_item in params_map:
                    new_key = key.replace(combined_item, params_map[combined_item])
                elif item in params_map and params_map[item] not in key:
                    new_key = key.replace(item, params_map[item])
